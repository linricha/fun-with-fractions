...
public class BFRegisterSet {
  ...
  /**
   * Sets up a register that stores a lowercase letter and the fraction stored inside.
   */
  public BFRegisterSet() {
    this.record = new BigFraction[ALPHABETLENGTH];
   ...
   * @return translates the letter value to an
   *  index value corresponding to how values are stored in record.
   */
